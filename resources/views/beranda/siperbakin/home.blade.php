...
<body>
    ...
    <nav class="navbar bg-danger navbar-expand-sm text-center sticky-top text-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">SIPERBAKIN</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarScroll" aria-controls="navbarScroll" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarScroll" style="text-decoration: white;">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Kategori3</a></li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="col-float-right">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav nav-item dropdown">
                        <a class="dropdown-toggle btn btn-dark" href="#" type="button" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Ahmadi (admin)
                        </a>
                        <ul class="dropdown-menu text-right">
                            <a class="btn btn-success" href="#" type="button">Tentang Kami</a>
    ...
    <section class="about_section">
        <div class="container mt-1">
            <div class="row">
                <div id="companySlider" class="carousel slide text-center" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <!-- Slide 1 -->
                        <div class="carousel-item active">
                            <img src="https://siperbakin.acehtamiangkab.go.id/storage/siperbakin_template/images/slider-img3.jpg" alt="Slide 1">
                        </div>
                        <!-- Slide 2 -->
                        <div class="carousel-item">
                            <img src="https://siperbakin.acehtamiangkab.go.id/storage/siperbakin_template/images/slider-img.jpg" alt="Slide 2">
                        </div>
                        <!-- Slide 3 -->
                        <div class="carousel-item">
                            <img src="https://siperbakin.acehtamiangkab.go.id/storage/siperbakin_template/images/slider-img3.jpg" alt="Slide 3">
                        </div>
                        <!-- Slide 4 -->
                        <div class="carousel-item">
                            <img src="https://siperbakin.acehtamiangkab.go.id/storage/siperbakin_template/images/slider-img.jpg" alt="Slide 4">
                        </div>
                        <!-- Slide 5 -->
                        <div class="carousel-item">
                            <img src="https://siperbakin.acehtamiangkab.go.id/storage/siperbakin_template/images/slider-img3.jpg" alt="Slide 5">
                        </div>
                    </div>
                    <!-- Controls -->
    ...
    <section class="about_section mt-1 bg-warning">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        ...
                        <div class="team-text">
                            <div class="bg-light">
                                <h5 class="fw-bold mb-0">Ahmadi Muslim, MP
                                </h5>
                                <small>Penata&nbsp;TK-I</small>
                            </div>
                            <div class="bg-primary">
                                <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
